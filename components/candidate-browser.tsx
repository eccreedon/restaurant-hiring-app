...
type Position = "server" | "bartender" | "sous-chef" | "line-cook" | "general-manager"
...
const mockCandidates: Record<Position, Candidate[]> = {
  ...
  "sous-chef": [
    {
      ...
      experience: [
        {
          timeframe: "2023-present",
          title: "Sous Chef at Emma's Farm to Table",
          location: "Uptown",
          url: "https://www.yelp.com/biz/farm-table-restaurant-uptown",
        },
        {
          timeframe: "2021-2023",
          title: "Sous Chef at Ceccioni's",
    ...
    },
    {
      ...
      experience: [
        {
          timeframe: "2024-present",
          title: "Sous Chef at Temayaki",
          location: "South Side",
          url: "https://www.yelp.com/biz/bbq-junction-south-side",
        },
        {
          timeframe: "2022-2024",
          title: "Grill Master at Fusion Bistro",
          location: "Downtown",
      ...
      videoUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_6412-EPUvF7FhLyi7g1blLr9NwSt4TryI0E.MOV",
      phone: "+1-555-0130",
      bio: "Grill specialist with fusion experience. Prev. sous chef at James Beard semifinalist restaurant. Expert in high-heat cooking and Asian flavor profiles.",
      skills: [
        "Cooking",
        "Food Prep",
        "Teamwork",
  ...
  "line-cook": [
    ...
    },
    {
      id: "11",
      name: "Carla Mendoza",
      photo: "/line-cook-apron-headshot.jpg",
      ...
      experience: [
        {
          timeframe: "2024-present",
          title: "Line Cook at Bianca Inotecca",
          location: "Westside",
          url: "https://www.yelp.com/biz/corner-deli-westside",
        },
        {
          timeframe: "2023-2024",
          title: "Line Cook at Joe's Crab Shack",
          location: "Northside",
          url: "https://www.yelp.com/biz/family-restaurant-northside",
        },
      ],
      videoUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_6412-EPUvF7FhLyi7g1blLr9NwSt4TryI0E.MOV",
      phone: "+1-555-0133",
      bio: "Eager line cook with 2+ years kitchen experience and strong work ethic. Recently completed food safety certification. Quick learner with excellent knife skills and passion for learning new cooking techniques.",
      skills: [
        "Food Prep",
        "Knife Skills",
        "Food Safety",
  ...
  "general-manager": [
    {
      ...
      photo: "/general-manager-headshot.jpg",
      ...
      experience: [
        {
          ...
          title: "General Manager at Harvest & Vine",
          location: "Uptown District",
          url: "https://www.yelp.com/biz/harvest-vine-uptown",
        },
        {
          timeframe: "2018-2021",
          title: "Assistant Manager at The Metropolitan",
          location: "Downtown Core",
          url: "https://www.yelp.com/biz/metropolitan-downtown",
        },
        {
          timeframe: "2016-2018",
          title: "Floor Manager at Coastal Kitchen",
          location: "Marina Bay",
          url: "https://www.yelp.com/biz/coastal-kitchen-marina",
        },
      ],
      videoUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_6412-EPUvF7FhLyi7g1blLr9NwSt4TryI0E.MOV",
      phone: "+1-555-0132",
      bio: "Proven restaurant leader with 8+ years management experience. Successfully increased revenue 35% at current location while maintaining 4.8-star rating. Expert in P&L management, staff development, and operational excellence.",
      skills: [
        "Leadership",
        "P&L Management",
        "Staff Training",
